#!/usr/bin/env python3
#SBATCH --job-name=m12r_potentials_dmo
#SBATCH --partition=high2m    # peloton high-mem node: 32 cores, 15.6 GB per core, 500 GB total
#SBATCH --mem=500G
#SBATCH --nodes=1
#SBATCH --ntasks=4    # processes total
#SBATCH --time=01:00:00
#SBATCH --output=/home/ibsantis/scripts/jobs/potentials/m12r_potentials_dmo_%j.txt
...
sim_data = orbit_io.OrbitRead(gal1='m12r', location='peloton', dmo=True)
print('Set paths')
