...
#
summary_plot.plot_hist(x=(d_rec_mod_pm-d_rec_mod)/d_rec_mod, xtype='d.peri.text', binsize=0.01, xlimits=(-0.3,0.5), pdf=True, x_labels='$(d_{\\rm peri,rec,point}-d_{\\rm peri,rec,disk})/d_{\\rm peri,rec,disk}$', file_path_and_name=directory+'/d_peri_rec_hist.pdf')
summary_plot.median_plot(x=d_rec_mod, y=(d_rec_mod_pm-d_rec_mod), xtype='d.peri.text', ytype='d.peri.text', binsize=25, limits=((0,300),(-5,25)), hl=True, axis_labels=['$d_{\\rm peri,rec,disk}$ [kpc]', '$d_{\\rm peri,rec,point}-d_{\\rm peri,rec,disk}$ [kpc]'], file_path_and_name=directory+'/delta_d_peri_rec_vs_rec.pdf')
summary_plot.median_plot(x=d_rec_mod, y=(d_rec_mod_pm-d_rec_mod)/d_rec_mod, xtype='d.peri.text', ytype='d.peri.text', binsize=25, limits=((0,300),(-0.01,0.2)), hl=True, axis_labels=['$d_{\\rm peri,rec,disk}$ [kpc]', '$(d_{\\rm peri,rec,point}-d_{\\rm peri,rec,disk})/d_{\\rm peri,rec,disk}$'], file_path_and_name=directory+'/d_peri_rec_frac_vs_rec.pdf')
...
#
summary_plot.plot_hist(x=(d_min_mod_pm-d_min_mod)/d_min_mod, xtype='d.peri.text', binsize=0.01, xlimits=(-0.3,0.5), pdf=True, x_labels='$(d_{\\rm peri,min,point}-d_{\\rm peri,min,disk})/d_{\\rm peri,min,disk}$', file_path_and_name=directory+'/d_peri_min_hist.pdf')
summary_plot.median_plot(x=d_min_mod, y=(d_min_mod_pm-d_min_mod), xtype='d.peri.text', ytype='d.peri.text', binsize=25, limits=((0,300),(-5,25)), hl=True, axis_labels=['$d_{\\rm peri,min,disk}$ [kpc]', '$d_{\\rm peri,min,point}-d_{\\rm peri,min,disk}$ [kpc]'], file_path_and_name=directory+'/delta_d_peri_min_vs_min.pdf')
summary_plot.median_plot(x=d_min_mod, y=(d_min_mod_pm-d_min_mod)/d_min_mod, xtype='d.peri.text', ytype='d.peri.text', binsize=25, limits=((0,300),(-0.01,0.2)), hl=True, axis_labels=['$d_{\\rm peri,min,disk}$ [kpc]', '$(d_{\\rm peri,min,point}-d_{\\rm peri,min,disk})/d_{\\rm peri,min,disk}$'], file_path_and_name=directory+'/d_peri_min_frac_vs_min.pdf')
...
#
summary_plot.plot_hist(x=(t_rec_mod_pm[mask]-t_rec_mod[mask]), xtype='t.peri.text', binsize=0.1, xlimits=(-1,2), pdf=True, x_labels='$(t_{\\rm peri,rec,point}-t_{\\rm peri,rec,disk})$ [Gyr]', file_path_and_name=directory+'/t_peri_rec_hist.pdf')
summary_plot.median_plot(x=t_rec_mod, y=(t_rec_mod_pm-t_rec_mod), xtype='t.peri.text', ytype='delta_t', binsize=0.5, limits=((9,0),(-0.5,1.5)), hl=True, axis_labels=['$t_{\\rm peri,rec,disk}$ [kpc]', '$t_{\\rm peri,rec,point}-t_{\\rm peri,rec,disk}$ [Gyr]'], file_path_and_name=directory+'/delta_t_peri_rec_vs_rec.pdf')
...
#
summary_plot.plot_hist(x=(v_rec_mod_pm-v_rec_mod), xtype='v.peri.text', binsize=5, xlimits=(-100,10), pdf=True, x_labels='$(v_{\\rm peri,rec,point}-v_{\\rm peri,rec,disk})$ [km s$^{-1}$]', file_path_and_name=directory+'/v_peri_rec_hist.pdf')
summary_plot.median_plot(x=v_rec_mod, y=(v_rec_mod_pm-v_rec_mod), xtype='v.peri.text', ytype='v.peri.text', binsize=25, limits=((0,650),(-150,10)), hl=True, axis_labels=['$v_{\\rm peri,rec,disk}$ [km s$^{-1}$]', '$v_{\\rm peri,rec,point}-v_{\\rm peri,rec,disk}$ [km s$^{-1}$]'], file_path_and_name=directory+'/delta_v_peri_rec_vs_rec.pdf')
...
#
summary_plot.plot_hist(x=(n_mod_pm-n_mod), xtype='N.peri.text', binsize=1, xlimits=(-3,1), pdf=True, x_labels='$(N_{\\rm peri,point}-N_{\\rm peri,disk})$', file_path_and_name=directory+'/N_peri_hist.pdf')
summary_plot.median_plot(x=n_mod, y=(n_mod_pm-n_mod), xtype='N.peri.text', ytype='N.peri.text', binsize=1, limits=((0,13),(-3,0.1)), hl=True, axis_labels=['$N_{\\rm peri,disk}$', '$N_{\\rm peri,point}-N_{\\rm peri,disk}$'], file_path_and_name=directory+'/delta_N_peri.pdf')
...
#
summary_plot.plot_hist(x=(n_mod_fixed_pm-n_mod_fixed), xtype='N.peri.text', binsize=1, xlimits=(-3,1), pdf=True, x_labels='$(N_{\\rm peri,point}-N_{\\rm peri,disk})$', file_path_and_name=directory+'/N_peri_fixed_hist.pdf')
summary_plot.median_plot(x=n_mod_fixed, y=(n_mod_fixed_pm-n_mod_fixed), xtype='N.peri.text', ytype='N.peri.text', binsize=1, limits=((0,13),(-3,0.1)), hl=True, axis_labels=['$N_{\\rm peri,disk}$', '$N_{\\rm peri,point}-N_{\\rm peri,disk}$'], file_path_and_name=directory+'/delta_N_peri_fixed.pdf')
...
#
summary_plot.plot_hist(x=(dapo_rec_mod_pm-dapo_rec_mod)/dapo_rec_mod, xtype='d.apo.text', binsize=0.01, xlimits=(-0.1,0.5), pdf=True, x_labels='$(d_{\\rm apo,rec,point}-d_{\\rm apo,rec,disk})/d_{\\rm apo,rec,disk}$', file_path_and_name=directory+'/d_apo_rec_hist.pdf')
summary_plot.median_plot(x=dapo_rec_mod, y=(dapo_rec_mod_pm-dapo_rec_mod)/dapo_rec_mod, xtype='d.apo.text', ytype='d.apo.text', binsize=25, limits=((0,500),(-0.05,0.3)), hl=True, axis_labels=['$d_{\\rm apo,rec,disk}$ [kpc]', '$(d_{\\rm apo,rec,point}-d_{\\rm apo,rec,disk})/d_{\\rm apo,rec,disk}$'], file_path_and_name=directory+'/d_apo_rec_frac_vs_rec.pdf')
