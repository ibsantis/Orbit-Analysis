#!/usr/bin/env python3
#SBATCH --job-name=m12r_summary_data
...
#SBATCH --output=/home/ibsantis/scripts/jobs/summary/m12r_summary_data_%j.txt
...
loc = 'peloton'
sim_data = orbit_io.OrbitRead(gal1='m12r', location=loc)
plotting = False
print('Set paths')
