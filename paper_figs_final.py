...
ax2.set_ylabel('Pericentre Lookback Time [Gyr]', fontsize=24)
...
axs[0,0].set_ylabel('Pericentre Number', fontsize=32)
axs[1,0].set_ylabel('Pericentre distance [kpc]', fontsize=30)
...
ax1.set_xlabel('Pericentre number', fontsize=32)
ax1.set_ylabel('Fraction with growing pericentres', fontsize=24)
...
ax2.set_ylabel('Min pericentre distance [kpc]', fontsize=24)
...
ax1.set_ylabel('Pericentre Number', fontsize=30)
ax1.xaxis.set_minor_locator(LogLocator(base=10,subs=[2,3,4,5,6,7,8,9]))
...
ax1.get_yaxis().set_label_coords(-0.1,0.5)
ax2.set_ylabel('Pericentre number', fontsize=28)
ax2.get_yaxis().set_label_coords(-0.1,0.5)
ax1.tick_params(axis='both', which='both', bottom=True, top=True, labelsize=27, labelbottom=False)
ax1.xaxis.set_minor_locator(LogLocator(base=10,subs=[2,3,4,5,6,7,8,9]))
ax2.xaxis.set_major_locator(LogLocator(base=10))
