...
# For mass tweaks, this worked well.
...
#
error_tweak = 5.0
err_name = 'host.distance.total.err'  # host.distance.total.err, host.velocity
file_save_path = sim_data.home_dir+f'/orbit_data/hdf5_files/satellite_matching/distance_tweaks/err_tweak_{error_tweak}/'

# Distance tweaks. I don't think I want to treat galaxies that don't have estimates the same...
for sat_name in mw_sats_1Mpc:
    tree_index = []
    mass_array = []
    weight = []
