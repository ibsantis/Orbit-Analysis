...
sim_data = orbit_io.OrbitRead(gal1=str(sys.argv[1]), location='mac')
print('Set paths')
...
if sim_data.num_gal == 1:
    ...
    for i in range(0, len(snaps)):
        data = ut.io.file_hdf5(sim_data.home_dir+'/orbit_data/hdf5_files/mass_profiles_new/'+sim_data.galaxy+'/'+sim_data.galaxy+'_mass_profile_'+str(snaps[i]), verbose=True)
    ...
    ut.io.file_hdf5(file_name_base=sim_data.home_dir+'/orbit_data/hdf5_files/mass_profiles_new/'+sim_data.galaxy+'_mass_profile_all', dict_or_array_to_write=data_dict, verbose=True)
