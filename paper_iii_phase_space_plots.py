...
#
axs[0,0].set_ylabel('N', fontsize=30)
axs[1,0].set_ylabel('$v_{\\rm tan}$ [km s$^{-1}$]', fontsize=30)
axs[2,0].set_ylabel('$v_{\\rm rad}$ [km s$^{-1}$]', fontsize=30)
axs[3,0].set_ylabel('$d$ [kpc]', fontsize=30)
axs[3,0].set_xlabel('log $M_{\\rm halo, peak}$', fontsize=30)
axs[2,1].set_xlabel('$d$ [kpc]', fontsize=30)
axs[1,2].set_xlabel('$v_{\\rm rad}$ [km s$^{-1}$]', fontsize=30)
axs[0,3].set_xlabel('$v_{\\rm tan}$ [km s$^{-1}$]', fontsize=30)
#
...
#
#plt.suptitle('{0} - Number of analogs = {1}'.format(galaxy, len(gal_data['Weight'])), fontsize=20)
axs[0,0].tick_params(axis='both', which='major', labelbottom=False, labelsize=24)
axs[1,0].tick_params(axis='both', which='major', labelbottom=False, labelsize=24)
axs[2,0].tick_params(axis='both', which='major', labelbottom=False, labelsize=24)
axs[3,0].tick_params(axis='both', which='major', labelsize=24)
axs[0,1].tick_params(axis='both', which='major', labelbottom=False, labelleft=False, labelsize=24)
axs[1,1].tick_params(axis='both', which='major', labelbottom=False, labelleft=False, labelsize=24)
axs[2,1].tick_params(axis='both', which='major', labelsize=24, labelleft=False)
axs[0,2].tick_params(axis='both', which='major', labelbottom=False, labelleft=False, labelsize=24)
axs[1,2].tick_params(axis='both', which='major', labelsize=24, labelleft=False)
axs[0,3].tick_params(axis='both', which='major', labelsize=24, labelleft=False)
#
