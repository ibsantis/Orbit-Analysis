...
plt.ylim(-0.1, 0.5)
plt.tight_layout()
plt.savefig(sim_data.home_dir+'/orbit_data/plots/summary/paper_2/stats/med_offset_sorted.pdf')
plt.close()
...
plt.ylim(0, 1.15)
plt.tight_layout()
plt.savefig(sim_data.home_dir+'/orbit_data/plots/summary/paper_2/stats/width_of_68_sorted.pdf')
plt.close()


# RMS
rms = np.array([  1.644, 2.144, 6.807, 0.611, 0.630, 0.193, 0.210, 0.186, 10.631, 30.342, 3.381, 0.226])
...
plt.ylim(0, 31)
plt.tight_layout()
plt.savefig(sim_data.home_dir+'/orbit_data/plots/summary/paper_2/stats/rms_sorted.pdf')
plt.close()
#
fig = plt.figure(figsize=(10, 8))
ax1 = fig.add_subplot(1,1,1)
...
plt.ylim(0, 11)
plt.tight_layout()
plt.savefig(sim_data.home_dir+'/orbit_data/plots/summary/paper_2/stats/rms_sorted_zoom1.pdf')
plt.close()
#
fig = plt.figure(figsize=(10, 8))
ax1 = fig.add_subplot(1,1,1)
...
plt.ylim(0, 7)
plt.tight_layout()
plt.savefig(sim_data.home_dir+'/orbit_data/plots/summary/paper_2/stats/rms_sorted_zoom2.pdf')
plt.close()
