...
print(np.median((d_rec_mod_rot_90x[mask]-d_rec_mod[mask])/d_rec_mod[mask]))
print(np.median((d_rec_mod_rot_90y[mask]-d_rec_mod[mask])/d_rec_mod[mask]))
print(np.median((d_rec_mod_rot_180x[mask]-d_rec_mod[mask])/d_rec_mod[mask]))
...
#
mask = (t_rec_mod != 0)*(d_rec_mod < 50)
print(np.median((t_rec_mod_rot_90x[mask]-t_rec_mod[mask])/t_rec_mod[mask]))
print(np.median((t_rec_mod_rot_90y[mask]-t_rec_mod[mask])/t_rec_mod[mask]))
print(np.median((t_rec_mod_rot_180x[mask]-t_rec_mod[mask])/t_rec_mod[mask]))
...
mask = (n_mod != 0)*(d_rec_mod != 0)*(d_rec_mod < 50)
print(np.median((n_mod_rot_90x[mask]-n_mod[mask])/n_mod[mask]))
print(np.median((n_mod_rot_90y[mask]-n_mod[mask])/n_mod[mask]))
print(np.median((n_mod_rot_180x[mask]-n_mod[mask])/n_mod[mask]))
...
#
mask = (n_mod_r200!= 0)*(d_rec_mod != 0)*(d_rec_mod < 50)
print(np.median((n_mod_r200_rot_90x[mask]-n_mod_r200[mask])/n_mod_r200[mask]))
print(np.median((n_mod_r200_rot_90y[mask]-n_mod_r200[mask])/n_mod_r200[mask]))
print(np.median((n_mod_r200_rot_180x[mask]-n_mod_r200[mask])/n_mod_r200[mask]))
...
d_rec_mod = summary.dperi_recent(data_total, masks_infall_peri, selection='model', oversample=True, hosts='all_no_r', sim_type='baryon')
mask = (d_rec_mod != 0)*(d_rec_mod < 50)
print(np.median((v_rec_mod_rot_90x[mask]-v_rec_mod[mask])/v_rec_mod[mask]))
print(np.median((v_rec_mod_rot_90y[mask]-v_rec_mod[mask])/v_rec_mod[mask]))
print(np.median((v_rec_mod_rot_180x[mask]-v_rec_mod[mask])/v_rec_mod[mask]))
...
mask = (d_rec_mod != 0)*(d_rec_mod < 50)
print(np.median((dapo_rec_mod_rot_90x[mask]-dapo_rec_mod[mask])/dapo_rec_mod[mask]))
print(np.median((dapo_rec_mod_rot_90y[mask]-dapo_rec_mod[mask])/dapo_rec_mod[mask]))
print(np.median((dapo_rec_mod_rot_180x[mask]-dapo_rec_mod[mask])/dapo_rec_mod[mask]))
...
#
d_rec_mod = summary.dperi_recent(data_total, masks_infall, selection='model', oversample=True, hosts='all_no_r', sim_type='baryon')
mask = (t_in_mod != 0)*(d_rec_mod != 0)*(d_rec_mod < 50)
print(np.median((t_in_mod_rot_90x[mask]-t_in_mod[mask])/t_in_mod[mask]))
print(np.median((t_in_mod_rot_90y[mask]-t_in_mod[mask])/t_in_mod[mask]))
print(np.median((t_in_mod_rot_180x[mask]-t_in_mod[mask])/t_in_mod[mask]))
...
#
mask = (t_in_mod_R200m != 0)*(d_rec_mod != 0)*(d_rec_mod < 50)
