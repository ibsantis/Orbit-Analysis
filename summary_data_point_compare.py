...
if sim_data.num_gal == 1:
    ...
    if point_mass:
        ...
        #
        disk_outer = DoubleExponentialDiskPotential(amp=fitting_data['A_disk_out'][sim_data.galaxy]*u.solMass/u.kpc**3, hr=(fitting_data['r_out'][sim_data.galaxy]*u.kpc)*0.01, hz=(fitting_data['h_z'][sim_data.galaxy]*u.kpc)*0.01)
        disk_inner = DoubleExponentialDiskPotential(amp=fitting_data['A_disk_in'][sim_data.galaxy]*u.solMass/u.kpc**3, hr=(fitting_data['r_in'][sim_data.galaxy]*u.kpc)*0.01, hz=(fitting_data['h_z'][sim_data.galaxy]*u.kpc)*0.01)
    ...
    if point_mass:
        ut.io.file_hdf5(file_name_base=sim_data.home_dir+'/orbit_data/hdf5_files/summary_data/point_mass_compare/data_'+sim_data.galaxy+'_1p_scale', dict_or_array_to_write=data_dict, verbose=True)
...
if sim_data.num_gal == 2:
    ...
    if point_mass:
        ...
        from galpy.potential import TwoPowerSphericalPotential # For DM halos
        #
        disk_outer = DoubleExponentialDiskPotential(amp=fitting_data['A_disk_out'][sim_data.gal_1]*u.solMass/u.kpc**3, hr=(fitting_data['r_out'][sim_data.gal_1]*u.kpc)*0.01, hz=(fitting_data['h_z'][sim_data.gal_1]*u.kpc)*0.01)
        disk_inner = DoubleExponentialDiskPotential(amp=fitting_data['A_disk_in'][sim_data.gal_1]*u.solMass/u.kpc**3, hr=(fitting_data['r_in'][sim_data.gal_1]*u.kpc)*0.01, hz=(fitting_data['h_z'][sim_data.gal_1]*u.kpc)*0.01)
    ...
    if point_mass:
        ut.io.file_hdf5(file_name_base=sim_data.home_dir+'/orbit_data/hdf5_files/summary_data/point_mass_compare/data_'+sim_data.gal_1+'_1p_scale', dict_or_array_to_write=data_dict, verbose=True)
    #
    ### GALAXY 2
    # Find the mass ratio to multiply the host radius
    ...
    if point_mass:
        ...
        from galpy.potential import TwoPowerSphericalPotential # For DM halos
        #
        disk_outer = DoubleExponentialDiskPotential(amp=fitting_data['A_disk_out'][sim_data.gal_2]*u.solMass/u.kpc**3, hr=(fitting_data['r_out'][sim_data.gal_2]*u.kpc)*0.01, hz=(fitting_data['h_z'][sim_data.gal_2]*u.kpc)*0.01)
        disk_inner = DoubleExponentialDiskPotential(amp=fitting_data['A_disk_in'][sim_data.gal_2]*u.solMass/u.kpc**3, hr=(fitting_data['r_in'][sim_data.gal_2]*u.kpc)*0.01, hz=(fitting_data['h_z'][sim_data.gal_2]*u.kpc)*0.01)
    ...
    #
    if point_mass:
        ut.io.file_hdf5(file_name_base=sim_data.home_dir+'/orbit_data/hdf5_files/summary_data/point_mass_compare/data_'+sim_data.gal_2+'_1p_scale', dict_or_array_to_write=data_dict, verbose=True)
