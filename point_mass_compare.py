...
d_rec_mod_1p = summary.dperi_recent(data_total_1p, masks_infall_peri_1p, selection='model', oversample=True, hosts='all_no_r', sim_type='baryon')
#
summary_plot.plot_hist_mult(x=[(d_rec_mod_kep-d_rec_mod)/d_rec_mod, (d_rec_mod_90p-d_rec_mod)/d_rec_mod, (d_rec_mod_50p-d_rec_mod)/d_rec_mod, (d_rec_mod_10p-d_rec_mod)/d_rec_mod, (d_rec_mod_1p-d_rec_mod)/d_rec_mod], xtype=['d.peri.text','d.peri.text','d.peri.text','d.peri.text','d.peri.text'], labels=['Keplerian', '90% hr, hz', '50% hr, hz', '10% hr, hz', '1% hr, hz'], binsize=0.01, xlimits=(-0.15, 0.15), pdf=True, x_label='$(d_{\\rm peri,rec,point}-d_{\\rm peri,rec,disk})/d_{\\rm peri,rec,disk}$', file_path_and_name=directory+'/d_peri_rec_hist.pdf')
