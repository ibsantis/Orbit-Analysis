#!/usr/bin/env python3
#SBATCH --job-name=RJ_mass_profile_all
...
#SBATCH --output=/home1/05400/ibsantis/scripts/jobs/mass_profiles/RJ_mass_profile_all_%j.txt
...
sim_data = orbit_io.OrbitRead(gal1='Romeo', location='stampede')
print('Set paths')
