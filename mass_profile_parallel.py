#!/usr/bin/env python3
#SBATCH --job-name=TL_mass_profile
...
##SBATCH --output=/home/ibsantis/scripts/jobs/mass_profiles/TL_mass_profile_%j.txt
#SBATCH --output=/home1/05400/ibsantis/scripts/jobs/mass_profiles/TL_mass_profile_%j.txt
